function varargout = spmb_triu2full(varargin)
% Convert a compact upper triangular matrix to a full matrix
%
% FORMAT F = spmb_triu2full(H)
% 
% H - (K2 x 1)  Batch of sparse matrices (K2 = (K*(K+1))/2)
% F - (K  x K)  Batch of full matrices
%__________________________________________________________________________
%
% FORMAT spmb_triu2full(...,'dim',DIM)
%
...
% followed by each row of the upper triangle
%
%                                       [ a d e ]
%       [ a b c d e f ]       =>        [ 0 b f ]
%                                       [ 0 0 c ]
