function y = spmb_tril_matvec(A,x,varargin)
% Matrix-vector multiplication, where the matrix is lower triangular
%
% FORMAT y = spmb_tril_matvec(A,x)
% 
...
%__________________________________________________________________________
%
% FORMAT spmb_tril_matvec(A,x,DIM)
% FORMAT spmb_tril_matvec(...,'dim',DIM)
%
...
%__________________________________________________________________________
%
% A lower triangular matrix stored in flattened form contains the diagonal 
% first, followed by each column of the lower triangle
%
%              [ a 0 0 ]
%              [ d b 0 ]      =>    [ a b c d e f ]
%              [ e f c ]
